...
const RegisterPage = () => {
    ...
    return (
        <div className="register">
            ...
            <p>Зарегистрируйтесь и начните свою работу</p>
...
// //                 login: formData.login
// //             });
// //             axiosInstance.post('https://server-node-7hwiaaeyb-azi-progerjs-projects.vercel.app/register', formData);
// //
// //
...
// //             }
// //         } catch (error) {
// //             setError(error.response ? error.response.data : 'Ошибка регистрации');
// //         }
// //     };
// //
// //     const styles = {
